    ...
    <>
      <div class="col-span-7 grid gap-4 px-3">
          ...
          <div class="h-48 overflow-y-scroll">
            <div class="grid gap-4">
              {userData?.education?.map((educationData, index) => {
                return (
                  <div class="grid rounded-lg border border-gray-200 bg-white py-2 shadow-sm md:mb-12 dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="pt-10 md:col-start-5 md:col-end-7">
          <div class="w-full max-w-sm rounded-lg border border-gray-200 bg-white px-2 pt-2 shadow dark:border-gray-700 dark:bg-gray-800">
            <div class="items-left flex flex-col pb-10">
              <h6 class="text-sm font-bold text-gray-900 md:mb-2 dark:text-white">
                Skills
              </h6>
              <div class="grid md:grid-cols-3">
                {userData?.skills?.map((skill) => {
                  return (
                    <div class="md-1 grid rounded-lg border border-gray-200 bg-white shadow-sm md:mb-1 dark:border-gray-700 dark:bg-gray-800">
                      <div class="relative grid select-none items-center whitespace-nowrap rounded-lg bg-gray-900 px-3 py-1.5 font-sans text-xs font-bold uppercase text-white">
              ...
              <h6 class="mb-2 pt-5 text-sm font-bold text-gray-900 dark:text-white">
                Languages
              </h6>
              <div class="grid md:grid-cols-3">
                {userData?.languages?.map((language) => {
                  return (
                    <div class="grid rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                      <div class="relative grid select-none items-center whitespace-nowrap rounded-lg bg-gray-900 px-3 py-1.5 font-sans text-xs font-bold uppercase text-white">
